...
import os
import numpy as np
from prompts.imagenet_template import openai_imagenet_template, car_template
...
class SFPForSegmentation(BaseSegmentor):
    ...
    def forward_feature(self, img, logit_size=None):
        ...
        if logit_size == None:
            ...
            logits = nn.functional.interpolate(logits, size=logit_size, mode='bilinear', align_corners=False)
    ...
    def forward_slide(self, img, img_metas, stride=112, crop_size=224):
        ...
        logits = nn.functional.interpolate(preds, size=img_size, mode='bilinear', align_corners=False)
