...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        data_prefix=dict(img_path='images/10k/val', seg_map_path='labels/val'),
        data_root='/data/JS/OVDG/data/BDD/bdd100k',
        pipeline=[
        ...
        type='BDD100KCityscapes19Dataset'),
    num_workers=4,
...
work_dir = '/data/JS/MyGithub_Repos/SFP/SFP_ICCV/work_logs_tf_ovdg_original/20260528_153324/bdd19_orig'
